      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 mb-12">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-3 self-start md:self-auto px-6 py-4 rounded-full border border-border bg-background text-foreground font-bold text-xs uppercase tracking-widest hover:bg-foreground hover:text-background transition-all duration-300 shadow-sm"
          >
            <Instagram size={15} />
            {HANDLE}
          </a>
          ...
          {looped.map((post, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-2.5 px-4 py-3 border-b border-border">
                <InstagramIcon />
                <div>
                  <p className="text-xs font-bold text-foreground leading-tight">latelier_by_mamy</p>
                  <p className="text-[10px] text-muted-foreground">El Jadida, Maroc</p>
                </div>
                <Instagram size={16} className="ml-auto text-muted-foreground/50" />
              </div>
              ...
              <div className="px-4 pt-3 pb-1 flex items-center gap-3">
                <Heart size={20} className="text-foreground/70 hover:text-red-500 transition-colors" />
              ...
              <div className="px-4 pb-4 pt-1">
                ...
                <p className="text-xs text-foreground/80 leading-relaxed line-clamp-2">
                  <span className="font-bold">latelier_by_mamy </span>
                  {post.caption}
                </p>
